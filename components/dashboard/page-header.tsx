  ...
  return (
    <div className="flex flex-col gap-4 px-4 pb-2 sm:px-0 lg:flex-row lg:items-end lg:justify-between">
      <div>
        ...
        <h1 className="mt-2 text-[2rem] font-semibold leading-[1.08] tracking-[-0.04em] text-[#181611] sm:text-[2.5rem]">{title}</h1>
        <p className="mt-3 max-w-2xl text-base leading-7 text-[#6e675c]">{description}</p>
      </div>
